...
<template>
  <div flex="~ row gap5" items-center text-lg mt-5>
    ...
    <a
      ...
      n-link
    >
      <div i-simple-icons:twitter text-2xl hover:text-primary-400 transition-all />
    </a>
    <a
      ...
      n-link
    >
      <div i-simple-icons:facebook text-2xl hover:text-primary-400 transition-all />
    </a>
    <a
      ...
      n-link
    >
      <div i-simple-icons:instagram text-2xl hover:text-primary-400 transition-all />
    </a>
    <a
      v-if="links.imdb_id"
      ...
      n-link
    >
      <div i-cib:imdb text-2xl hover:text-primary-400 transition-all />
    </a>
    <a
      ...
      n-link
    >
      <div i-simple-icons:github text-2xl hover:text-primary-400 transition-all />
    </a>
    <a
      ...
      n-link
    >
      <div i-simple-icons:linkedin text-2xl hover:text-primary-400 transition-all />
    </a>
    <a
      v-if="links.email"
      :href="links.email"
      ...
      n-link
    >
      <div i-ph-envelope-simple text-2xl hover:text-primary-400 transition-all />
    </a>
    <a
      v-if="links.homepage"
      :href="links.homepage"
      ...
      n-link
    >
      <div i-ph-link-simple text-2xl hover:text-primary-400 transition-all />
    </a>
    <slot />
  </div>
</template>
