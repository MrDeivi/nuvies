 ...
 * Get genre list
 */
export function getGenreList(media: string): Promise<{ genres: { name: string; id: number }[] }> {
...
export function getPeople(): Promise<PageResult<Person>> {
  return fetchTMDB('trending/person/week')
}
